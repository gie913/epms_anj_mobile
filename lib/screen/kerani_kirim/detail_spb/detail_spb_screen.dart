            ...
            appBar: AppBar(
              ...
              bottom: TabBar(
                tabs: <Widget>[
                  ...
                  Tab(
                    icon: Text("OPH (${detailSPB.listSPBDetail.length})"),
                  ),
                  Tab(
                    icon: Text("Loader (${detailSPB.listSPBLoader.length})"),
                  ),
                ],
              ),
            ),
                  ...
                  child: Column(children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          detailSPB.spb?.spbType == 1
                              ? Text(
                                  "${detailSPB.spb?.spbEstateVendorCode ?? ""}")
                              : detailSPB.spb?.spbType != 3
                                  ? Text(
                                    ...
                                    child: Focus(
                                      child: TextFormField(
                                        ...
                                        onFieldSubmitted: (value) {
                                          detailSPB.checkSPBCard(context,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Total OPH:"),
                          Text("${detailSPB.listSPBDetail.length}")
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Total janjang:"),
                          Text("${detailSPB.spb?.spbTotalBunches}")
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("${detailSPB.spb?.spbTotalLooseFruit}")
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("${detailSPB.spb?.spbEstimateTonnage}")
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("${detailSPB.spb?.spbCapacityTonnage ?? 0}")
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("${detailSPB.spb?.spbActualTonnage ?? ""}")
                        ],
                      ),
                    ),
                    Padding(
              ...
              Center(
                child: Column(children: [
                  Padding(
                    ...
                    child:
                        Text("Daftar OPH (${detailSPB.listSPBDetail.length})"),
                  ),
                  Flexible(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text("Nama Loader:"),
                                      Text(
                                          "${detailSPB.listSPBLoader[index].loaderEmployeeCode} ${detailSPB.listSPBLoader[index].loaderEmployeeName}"),
                                    ],
                                  ),
                                  Row(
                                    mainAxisAlignment:
