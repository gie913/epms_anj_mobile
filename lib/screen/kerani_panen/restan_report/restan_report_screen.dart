              ...
              child: Column(children: [
                ...
                restanReport.listRestan.isEmpty
                    ? Container(
                        ...
                        height: 200,
                        child: Text("Tidak ada Restan", style: Style.textBold16))
                        ...
                        ? Flexible(
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: () {
                                      restanReport.onClickRestan(widget.method, restanReport.listRestanResult[index]);
                                    },
                                    child: Card(
                                      child: Padding(
                        ...
                        : Flexible(
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: () {
                                      restanReport.onClickRestan(widget.method, restanReport.listRestan[index]);
                                    },
                                    child: Card(
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
